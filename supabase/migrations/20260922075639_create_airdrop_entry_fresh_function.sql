/*
# Create new airdrop submission function with fresh name

PostgREST schema cache is stale for `submit_airdrop` (PGRST202).
Creating a new function with a different name forces PostgREST to
load it fresh. The logic is identical to submit_airdrop.
*/
